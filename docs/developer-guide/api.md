...
Lobby buzzer discovery also publishes the admin-only `button_clicked` WebSocket event; it is generated by the hardware adapter rather than by a REST endpoint.
