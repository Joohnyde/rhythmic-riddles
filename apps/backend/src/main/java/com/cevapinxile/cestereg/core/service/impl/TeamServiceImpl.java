...
public class TeamServiceImpl implements TeamService {
  ...
  private void addToCache(final String roomCode) throws InvalidReferencedObjectException {
    if (!scoreMap.containsKey(roomCode)) {
      ...
      final TeamScoreCache teamScoreCache = new TeamScoreCache(teamScores);
