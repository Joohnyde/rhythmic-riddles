                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E002 - Malformed argument\","
                                + "\"message\":\"Request body must contain a valid teamId (UUID).\"}"))),
    @ApiResponse(
        responseCode = "404",
                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E001 - Invalid referenced object\","
                                + "\"message\":\"Game, team, or category was not found for the provided identifiers.\"}"))),
    @ApiResponse(
        responseCode = "409",
                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E003 - Wrong game-state\","
                                + "\"message\":\"Category picking is only allowed in stage 1 (album selection).\"}"))),
    @ApiResponse(
        responseCode = "503",
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E002 - Malformed argument\","
                                + "\"message\":\"Category exists but is not part of the specified game (roomCode).\"}"))),
    @ApiResponse(
        responseCode = "404",
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E001 - Invalid referenced object\","
                                + "\"message\":\"Category was not found for the provided categoryId.\"}"))),
    @ApiResponse(
        responseCode = "409",
        description = "Game isn't in stage 1.",
        content =
