...
@NamedQueries({
  ...
  @NamedQuery(
      name = "InterruptEntity.findByArrivedAt",
      query = "SELECT i FROM InterruptEntity i WHERE i.arrivedAt = :arrivedAt"),
  @NamedQuery(
      name = "InterruptEntity.findByResolvedAt",
      query = "SELECT i FROM InterruptEntity i WHERE i.resolvedAt = :resolvedAt"),
  @NamedQuery(
      name = "InterruptEntity.findByIsCorrect",
      query = "SELECT i FROM InterruptEntity i WHERE i.isCorrect = :isCorrect"),
  @NamedQuery(
      name = "InterruptEntity.findByScoreOrScenarioId",
      query = "SELECT i FROM InterruptEntity i WHERE i.scoreOrScenarioId = :scoreOrScenarioId"),
  @NamedQuery(
      name = "InterruptEntity.findInterrupts",
      query =
          """
  ...
  @NamedQuery(
      name = "InterruptEntity.findLastPause",
      query =
          """
              SELECT i
              ...
              """),
  @NamedQuery(
      name = "InterruptEntity.findLastAnswer",
      query =
          """
              SELECT i
              FROM   InterruptEntity i
              ...
              """),
  @NamedQuery(
      name = "InterruptEntity.didTeamAnswer",
      query =
          """
              SELECT    TRUE
              FROM      InterruptEntity i
  ...
  @NamedQuery(
      name = "InterruptEntity.resolveErrors",
      query =
          """
  ...
  @NamedQuery(
      name = "InterruptEntity.findCorrectAnswer",
      query =
          "SELECT i.teamId.id FROM InterruptEntity i WHERE i.scheduleId.id = :scheduleId AND i.isCorrect = true"),
  @NamedQuery(
      name = "InterruptEntity.findPreviousScenarioId",
      query =
          """
