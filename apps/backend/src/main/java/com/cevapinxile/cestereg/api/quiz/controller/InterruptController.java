...
""")
                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E001 - Invalid referenced object\","
                                + "\"message\":\"Game was not found for roomCode, or teamId does not exist.\"}"))),
    @ApiResponse(
        responseCode = "409",
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E006 - Guess wasn't allowed\","
                                + "\"message\":\"Interrupt rejected: song is not currently played.\"}"))),
    @ApiResponse(
        responseCode = "401",
  ...
  public ResponseEntity<?> interrupt(
      @RoomCodePath @PathVariable String roomCode, @RequestBody TeamIdRequest tir) {
    try {
...
""")
                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E003 - Wrong game-state\","
                                + "\"message\":\"System error resolution is only allowed in stage 2 (song playing).\"}"))),
    @ApiResponse(
        responseCode = "503",
  ...
  public ResponseEntity<?> resolveErrors(
      @RoomCodePath @PathVariable String roomCode, @RequestBody ScheduleIdRequest sir) {
    try {
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E001 - Invalid referenced object\","
                                + "\"message\":\"Game was not found for roomCode or interrupt was not found for answerId.\"}"))),
    @ApiResponse(
        responseCode = "422",
                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E002 - Malformed argument\","
                                + "\"message\":\"Interrupt does not belong to the specified game (roomCode mismatch).\"}"))),
    @ApiResponse(
        responseCode = "409",
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E003 - Wrong game-state\","
                                + "\"message\":\"Answering is only allowed in stage 2 and only for unresolved interrupts.\"}"))),
    @ApiResponse(
        responseCode = "503",
        description = "One of the apps is missing.",
        content =
...
""")
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E002 - Malformed argument\","
                                + "\"message\":\"scenario must be 0..4 and must not be 3.\"}"))),
    @ApiResponse(
        responseCode = "409",
        description = "Game isn't in stage 2.",
        content =
  ...
  public ResponseEntity<?> savePreviousScenario(
      @RoomCodePath @PathVariable String roomCode, @RequestBody ScenarioRequest sr) {
    try {
