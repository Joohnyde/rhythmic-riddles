                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E001 - Invalid referenced object\","
                                + "\"message\":\"Snippet audio for songId was not found on disk.\"}"))),
    @ApiResponse(
        responseCode = "503",
                    ...
                    @ExampleObject(
                        value =
                            "{\"error\":\"E004 - App not reachable\","
                                + "\"message\":\"Snippet audio exists but could not be read due to an IO error.\"}"))),
    @ApiResponse(
        responseCode = "500",
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E999 - Internal error\","
                                + "\"message\":\"Unexpected server error while reading snippet audio.\"}")))
  })
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E001 - Invalid referenced object\","
                                + "\"message\":\"Answer audio for songId was not found on disk.\"}"))),
    @ApiResponse(
        responseCode = "503",
            ...
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E004 - App not reachable\","
                                + "\"message\":\"Answer audio exists but could not be read due to an IO error.\"}"))),
    @ApiResponse(
        responseCode = "500",
        description = "Unforeseen error.",
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"error\":\"E999 - Internal error\","
                                + "\"message\":\"Unexpected server error while reading answer audio.\"}")))
  })
