...
class GameServiceImplWebSocketTest {
    ...
    class GameServiceImplIllegalTransitionNonEmissionTest {
            ...
            class IsChangeStageLegalNonEmissionSignals {
                ...
                void unknownRoomThrowsAndDoesNotTouchPresenceOrBroadcasting() {
                    ...
                    assertThrows(InvalidReferencedObjectException.class, () -> service.isChangeStageLegal(1, "MISS"));
    ...
    class GameServiceImplIteration7Stage2RecoveryTest {
          ...
          class RecoveryMatrix {
            ...
            void reconnectDuringNormalPlaybackReturnsSeekRemainingAndNoPauseFlags() throws Exception {
              ...
              when(interruptService.calculateSeek(schedule.getStartedAt(), schedule.getId())).thenReturn(4000L);
            ...
            @Test
            void reconnectAfterTeamInterruptReturnsAnsweringSnapshotAndPrefersItOverSystemPause() throws Exception {
              final GameEntity game = game();
              final ScheduleEntity schedule = schedule(game, 25.0, 7.0);
              ...
              when(interruptService.calculateSeek(schedule.getStartedAt(), schedule.getId())).thenReturn(2000L);
              when(interruptService.getLastTwoInterrupts(schedule.getStartedAt(), schedule.getId()))
            ...
            @Test
            void reconnectAfterWrongAnswerResolutionReturnsPlaybackRecoveryWithoutAnsweringState() throws Exception {
              final GameEntity game = game();
              final ScheduleEntity schedule = schedule(game, 25.0, 7.0);
              final TeamEntity team = team(game, "Blue");
              ...
              when(scheduleRepository.findLastPlayed(game.getId())).thenReturn(schedule);
              when(teamService.getTeamScores("AKKU")).thenReturn(List.of());
              when(interruptService.calculateSeek(schedule.getStartedAt(), schedule.getId())).thenReturn(9000L);
              when(interruptService.getLastTwoInterrupts(schedule.getStartedAt(), schedule.getId()))
            ...
            @Test
            void reconnectWhileSystemPauseIsActiveReturnsErrorSnapshotWithoutAnsweringTeam() throws Exception {
              final GameEntity game = game();
              final ScheduleEntity schedule = schedule(game, 25.0, 7.0);
              final InterruptEntity systemPause = new InterruptEntity(UUID.randomUUID());
              systemPause.setResolvedAt(null);
              ...
              when(scheduleRepository.findLastPlayed(game.getId())).thenReturn(schedule);
              when(teamService.getTeamScores("AKKU")).thenReturn(List.of());
              when(interruptService.calculateSeek(schedule.getStartedAt(), schedule.getId())).thenReturn(3000L);
              when(interruptService.getLastTwoInterrupts(schedule.getStartedAt(), schedule.getId()))
            ...
            @Test
            void reconnectAfterSnippetEndsButBeforeRevealReturnsEndedNotRevealedSnapshot() throws Exception {
              final GameEntity game = game();
              ...
              when(scheduleRepository.findLastPlayed(game.getId())).thenReturn(schedule);
              when(teamService.getTeamScores("AKKU")).thenReturn(List.of());
              when(interruptService.calculateSeek(schedule.getStartedAt(), schedule.getId())).thenReturn(7000L);
            ...
            void reconnectAfterProgressToNextSongReturnsWelcomeForNewSchedule() throws Exception {
              ...
              when(teamService.getTeamScores("AKKU")).thenReturn(scores);
              when(interruptService.calculateSeek(nextSong.getStartedAt(), nextSong.getId())).thenReturn(0L);
    ...
    class GameServiceImplNonStage2RecoveryTest {
            ...
            class LobbyRecovery {
                ...
                void contextFetchLobbyReturnsWelcomeStageAndCurrentTeamList() throws Exception {
                    final GameEntity game = mock(GameEntity.class);
                    final List<CreateTeamResponse> teams = List.of(
                            mock(CreateTeamResponse.class),
                            mock(CreateTeamResponse.class)
                    );
            ...
            class AlbumsRecovery {
                ...
                void contextFetchAlbumsPickerStateWhenNoLastCategoryExists() throws Exception {
                    ...
                    final List<CategorySimple> albums = List.of(
                            mock(CategorySimple.class),
                            mock(CategorySimple.class)
                    );
                    ...
                    final CreateTeamResponse team = assertInstanceOf(CreateTeamResponse.class, payload.get("team"));
    ...
    class GameServiceImplNonStage2SchemaRegressionTest {
            ...
            class AlbumsSchema {
                ...
                @Test
                void albumsImpossibleEndBranchContainsNoPickerNoSelectedAndNoPlaybackFields() throws Exception {
                    final GameEntity game = mock(GameEntity.class);
                    final UUID gameId = UUID.randomUUID();
                    final LastCategory last = mock(LastCategory.class);
                ...
                @Test
                void albumsStartedPreviousCategoryBranchCanExposeNullPickerButNoPlaybackFields() throws Exception {
                    final GameEntity game = mock(GameEntity.class);
                    final UUID gameId = UUID.randomUUID();
                    final LastCategory last = mock(LastCategory.class);
    ...
    class GameServiceImplNonStage2TransitionTest {
            ...
            class IsChangeStageLegal {
                ...
                void rejectsUnknownRoom() {
                    ...
                    final InvalidReferencedObjectException ex = assertThrows(
                ...
                void rejectsStageBelowRange() {
                    ...
                    final InvalidArgumentException ex = assertThrows(
                            ...
                            () -> service.isChangeStageLegal(-1, "ROOM"));
                ...
                void rejectsStageAboveRange() {
                    ...
                    final InvalidArgumentException ex = assertThrows(
                            InvalidArgumentException.class,
                            () -> service.isChangeStageLegal(4, "ROOM"));
                ...
                void rejectsLobbyToAnythingExceptAlbums() {
                    ...
                    final WrongGameStateException ex = assertThrows(
                            WrongGameStateException.class,
                            () -> service.isChangeStageLegal(2, "ROOM"));
                ...
                void rejectsAlbumsToAnythingExceptSongs() {
                    ...
                    final WrongGameStateException ex = assertThrows(
                            WrongGameStateException.class,
                            () -> service.isChangeStageLegal(3, "ROOM"));
                ...
                void rejectsSongsToLobby() {
                    ...
                    final WrongGameStateException ex = assertThrows(
                            WrongGameStateException.class,
                            () -> service.isChangeStageLegal(0, "ROOM"));
                ...
                void rejectsAnyOtherwiseLegalTransitionWhenTvIsMissing() {
                    ...
                    final AppNotRegisteredException ex = assertThrows(
            ...
            class ChangeStageBroadcasting {
                ...
                void changeStagePersistsNewStateAndBroadcastsFreshWelcomeSnapshot() throws Exception {
                    ...
                    verify(game).setStage(1);
                    verify(gameRepository).saveAndFlush(game);
                    verify(broadcastGateway).broadcast(eq("ROOM"), eq(new ObjectMapper().writeValueAsString(payload)));
                }
                ...
                void changeStageDoesNotBroadcastWhenLegalityCheckThrows() throws Exception {
                    ...
                    doThrow(new AppNotRegisteredException("TV app has to be connected to proceed"))
                            .when(failingSpy).isChangeStageLegal(1, "ROOM");
