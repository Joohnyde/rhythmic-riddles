  ...
  class InterruptServiceImplIteration7TransitionWsTest {
    ...
    class Stage2TransitionContracts {
      ...
      void teamInterruptPersistsBeforeBroadcastingPauseFrame() throws Exception {
        ...
        final ArgumentCaptor<InterruptEntity> savedInterrupt =
      ...
      void systemPausePersistsBeforeBroadcastingPauseFrameWithNullTeam() throws Exception {
        ...
        assertTrue(
            payload
                .getValue()
                .contains("\"interruptId\":\"" + savedInterrupt.getValue().getId() + "\""));
      }

      @Test
      void teamInterruptIsRejectedWhenAnotherTeamIsAlreadyAnsweringAndDoesNotBroadcast()
          throws Exception {
        final GameEntity game = game("AKKU");
        ...
        final GuessNotAllowedException exception =
            assertThrows(
                GuessNotAllowedException.class, () -> service.interrupt("AKKU", second.getId()));
      ...
      @Test
      void teamInterruptIsRejectedWhenSystemPauseIsStillActiveAndDoesNotBroadcast()
          throws Exception {
        final GameEntity game = game("AKKU");
        final TeamEntity team = team(game, "Blue");
        final ScheduleEntity schedule = playingSchedule(game, 20.0, 8.0);
        ...
        final GuessNotAllowedException exception =
            assertThrows(
                GuessNotAllowedException.class, () -> service.interrupt("AKKU", team.getId()));
      ...
      @Test
      void answerWrongResolvesInterruptSavesTeamAnswerAndBroadcastsExactlyOneAnswerFrame()
          throws Exception {
        final GameEntity game = game("AKKU");
        final TeamEntity team = team(game, "Blue");
        final ScheduleEntity schedule = playingSchedule(game, 20.0, 8.0);
      ...
      void resolveErrorsBroadcastsPreviousScenarioAfterRepositoryResolution() throws Exception {
        ...
        inOrder
            ...
            .broadcast(eq("AKKU"), eq("{\"type\":\"error_solved\",\"previousScenario\":4}"));
      }
      ...
      private ScheduleEntity playingSchedule(
