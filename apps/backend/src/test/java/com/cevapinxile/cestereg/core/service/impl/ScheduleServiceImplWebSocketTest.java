...
class ScheduleServiceImplWebSocketTest {
  ...
  class ScheduleServiceImplIteration7TransitionWsTest {
    ...
    class Stage2SequenceContracts {
      ...
      @Test
      void replaySongResolvesErrorsThenSavesStartTimeThenBroadcastsRepeatExactlyOnce()
          throws Exception {
      ...
      @Test
      void revealAnswerResolvesErrorsThenPersistsRevealThenBroadcastsRevealExactlyOnce()
          throws Exception {
        final GameEntity game = game("AKKU");
        final ScheduleEntity schedule = schedule(game, 17.5, 6.0);
      ...
      @Test
      void progressChangesStageInsteadOfBroadcastingSongNextWhenPlaylistIsFinished()
          throws Exception {
        final GameEntity game = game("AKKU");
        final ScheduleEntity lastPlayed = schedule(game, 11.0, 5.0);
