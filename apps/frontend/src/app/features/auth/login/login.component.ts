...
import { GameRealtimeService, ClientSurface } from '../../../core/realtime/game-realtime.service';
    ...
    try {
      ...
      if (first.type === 'welcome') {
        ...
        await this.router.navigate(
          this.surface === 'admin' ? ['admin', first.stage] : [first.stage],
        );
      }
    } catch {
